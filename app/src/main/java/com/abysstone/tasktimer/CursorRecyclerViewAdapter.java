...
//            Log.d(TAG, "TaskViewHolder: starts");
            ...
            this.name = itemView.findViewById(id.tli_name);
            this.description = itemView.findViewById(id.tli_description);
            this.editButton = itemView.findViewById(id.tli_edit);
            this.deleteButton = itemView.findViewById(id.tli_delete);
